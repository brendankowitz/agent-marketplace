...
| `build` | Levelled coding agents (`fast-coding-agent` → `coding-agent` → `complex-coding-agent`) with clean-code design guidance + `implement-task`, `engineer-mode` skills | BSD-3-Clause |
